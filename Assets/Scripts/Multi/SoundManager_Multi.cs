...
public class SoundManager_Multi : MonoBehaviour
{
    public enum Sound
    {
        Bgm,
    ...
    public static SoundManager_Multi Instance { get; private set; }
    ...
    public void Init()
    {
        GameObject root = GameObject.Find("SoundManager_Multi");
